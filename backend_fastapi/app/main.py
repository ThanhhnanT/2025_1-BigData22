...
# import redis.asyncio as redis  # COMMENTED OUT FOR MONGODB ONLY TESTING
...
async def lifespan(app: FastAPI):
    ...
    # COMMENTED OUT FOR MONGODB ONLY TESTING
    ...
    # await redis_client.aclose()  # COMMENTED OUT
    mongo_client.close()
...
# COMMENTED OUT FOR MONGODB ONLY TESTING - USES REDIS
